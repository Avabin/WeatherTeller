...
internal class EntityFrameworkWeatherForecastDataSource :
    EntityFrameworkDataSourceBase<WeatherForecastEntity, WeatherForecastSnapshot, ulong>, IWeatherDataSource
{
    public EntityFrameworkWeatherForecastDataSource(IDbContextFactory<ApplicationDbContext> dbContextFactory) : base(
        dbContextFactory)
    {
    }
